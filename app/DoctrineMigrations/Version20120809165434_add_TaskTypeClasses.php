 ...
 */
class Version20120809165434_add_TaskTypeClasses extends EntityModificationMigration
{
    ...
    public function postDown(Schema $schema) {
        foreach ($this->taskTypeClasses as $name => $description) {
            $taskTypeClass = $this->getEntityManager()->getRepository('SimplyTestable\WorkerBundle\Entity\Task\Type\TaskTypeClass')->findOneByName($name);
