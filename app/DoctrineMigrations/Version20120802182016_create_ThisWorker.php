...
class Version20120802182016_create_ThisWorker extends EntityModificationMigration
{
    ...
    {        
        $this->statements['mysql'] = array(
            "CREATE TABLE ThisWorker (id INT AUTO_INCREMENT NOT NULL, state_id INT NOT NULL, hostname VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8F360729F47645AE (hostname), INDEX IDX_8F3607295D83CC1 (state_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = InnoDB",
