...
class SingleChildStylesheetCurlErrorTest extends ConsoleCommandBaseTestCase {    
    ...
    public function assertHttpRetrievalFailureCodeMatchesReceivedResponse($statusCode) {
        ...
        $this->assertEquals('[{"message":"http-retrieval-curl-code-'.$statusCode.'","context":"","line_number":0,"type":"error","ref":"http:\/\/example.com\/style.css"}]', $task->getOutput()->getOutput());             
    }   
