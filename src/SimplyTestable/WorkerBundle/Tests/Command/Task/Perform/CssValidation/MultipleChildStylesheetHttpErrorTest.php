...
class MultipleChildStylesheetHttpErrorTest extends ConsoleCommandBaseTestCase {    
    ...
    public function assertHttpRetrievalFailureCodeMatchesReceivedResponse($statusCode) {
        ...
        $this->assertEquals('[{"message":"http-retrieval-'.$statusCode.'","context":"","line_number":0,"type":"error","ref":"http:\/\/example.com\/style2.css"}]', $task->getOutput()->getOutput());             
    }   
